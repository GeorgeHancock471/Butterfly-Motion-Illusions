...
//  USER OPTIONS
	...
	settingsChoice = defaultSettings[0];
	nonLin = defaultSettings[12];
	greyLocation = defaultSettings[1];
	estimateBlack = defaultSettings[2];
	standardString =  defaultSettings[3];
	customiseLevels = defaultSettings[4];
	customiseLocation = defaultSettings[5];
	autoAlignOption = defaultSettings[7];
	imageOutput =defaultSettings[13];
