...
% NAME:  function for screen, ramp

% Function:
% Slightly redudant script if you use dot to start. As the frame rate has
% to build up to the max frame rate this can be used to help build up the
% frame rate.
...
function f_screen_ramp(window,waitScreenColor)
