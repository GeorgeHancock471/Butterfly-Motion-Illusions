...
% NAME:  function for screen, primary Left minimise

% Function:
%
% EXPERIMENTAL!!!
% Switches the primary monitor to the left monitor, can be used as a quick
...
Side = "L";  % "L" or "R" for left or right screen
